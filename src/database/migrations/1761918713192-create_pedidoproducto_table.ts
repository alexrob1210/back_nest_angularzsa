...
export class CreatePedidoproductoTable1761918713192 implements MigrationInterface {
    name = 'CreatePedidoproductoTable1761918713192'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "productos" RENAME COLUMN "descripción" TO "descripcion"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "productos" RENAME COLUMN "descripcion" TO "descripción"`);
    }
