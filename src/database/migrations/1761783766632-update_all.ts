...
export class UpdateAll1761783766632 implements MigrationInterface {
    name = 'UpdateAll1761783766632'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "cedula" character varying NOT NULL, "telefono" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
